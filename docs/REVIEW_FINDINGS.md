...
| D2 | TBD | BLE random-static address now derived per-device from esp_efuse_mac_get_default + top 2 bits set; SECURITY.md updated. Bonds from prior firmware invalidated — one-time re-pair required. |
